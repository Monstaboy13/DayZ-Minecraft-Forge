...
public class BlockChestCommon extends BlockContainer
{
    ...
    public BlockChestCommon(int par1)
    {
	            ...
	            while (continueChecking == true)
	            {
	            	if (tileentitychest.getStackInSlot(slotNumber) == null && slotNumber < 27)
	            	{
	                    if(slotNumber == 26)
	                    {
	                        ...
	                        {
	                    		WeightedRandomChestContent.generateChestContents(random1, ChestHookRegistry.chestCommonContents, tileentitychest, random1.nextInt(5) + 1);	
